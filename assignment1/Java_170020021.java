...
class MergeSort {
    ...
    public static void sort(int[] inputList, int leftIndex, int rightIndex){
    ...
    public static void mergeList(int[] inputList, int leftIndex, int middleIndex, int rightIndex){
        ...
        while(l<size1 && r<size2){
            inputList[currentIndex++] = (leftTempArray[l]<=rightTempArray[r])? leftTempArray[l++] : rightTempArray[r++];
        }
